...
/*
 * step 1: build by exececuting make inside the raylib/src folder
 * this will result in a bunch of object files, an example of compiling your app would be:
 * cc raylibTest.c ../lib/raylib/src/*.o -lm
 **/
